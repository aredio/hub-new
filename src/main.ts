...
class HubFinanceiro {
    ...
    private setupEventListeners(): void {
        ...
        buttons.forEach((button, index) => {
            const container = button.closest('.button-container') as HTMLElement;
            ...
            if (functionId) {
                ...
                button.addEventListener('mouseenter', () => {
                    this.addHoverEffect(button as HTMLElement);
                });

                button.addEventListener('mouseleave', () => {
                    this.removeHoverEffect(button as HTMLElement);
                });
            }
        });
    ...
    private executeFunction(func: FinancialFunction): void {
    ...
    private openImpostosInvest(): void {
        // Adicionar efeito de transição suave
        this.addPageTransitionEffect();
        setTimeout(() => {
    ...
    private openFinanciamento(): void {
        // Adicionar efeito de transição suave
        this.addPageTransitionEffect();
        setTimeout(() => {
    ...
    private showComingSoon(functionName: string, pageName: string): void {
    ...
    private showTechnicalDetails(functionName: string): void {
        let details = '';
